...
1. 通过访问警报生成器开始创建警报。 <!-- add this back in after the other methods are available like in AA and make a bulleted list: "You can access the alert builder in any of the following ways:" -->在Customer Journey Analytics中，选择&#x200B;**[!UICONTROL 组件]** > [!UICONTROL **警报**] > **[!UICONTROL 创建新警报]**。
