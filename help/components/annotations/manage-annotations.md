...
所有注释都使用时间戳创建，但没有“时间”或“时区”信息。 在报告时，将始终应用面板数据视图的时区。 因此，无论您处于什么数据查看时区，为圣诞节创建的注释都会在12月25日发生。
...
| 筛选（左边栏） | 按标记、数据视图、所有者和其他过滤器（“我的”、“已批准”、“收藏夹”、“与我共享”和“显示全部”）进行过滤。 |
