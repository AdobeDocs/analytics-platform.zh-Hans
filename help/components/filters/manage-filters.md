...
过滤器管理器优惠了多种管理过滤器的方式，如共享、标记、批准、复制、删除和标记为收藏。
...
花一些时间规划过滤器可以提高这些应用程序对您的组织非常有用并且其数量将受到控制的可能性。
...
在过滤器管理器中，您可以通过标记过滤器来组织过滤器。所有用户都可以为过滤器创建标记并将一个或多个标记应用到筛选器。 但是，您只能查看您所拥有的或与您共享的那些过滤器的标记。
...
1. 您还可以单击&#x200B;**[!UICONTROL 取消批准]**&#x200B;来取消批准已批准的筛选器。
