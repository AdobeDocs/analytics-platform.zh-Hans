...
1. 右键单击表中的列，然后选择&#x200B;**[!UICONTROL 添加时间段列]** ![添加时间段列突出显示](assets/add-time-period-column.png)的表列列表
...
![带有表设置的自由格式表弹出窗口显示从每列到所有开始日期在选定同一行上的对齐日期。](assets/date-comparison-setting.png)
