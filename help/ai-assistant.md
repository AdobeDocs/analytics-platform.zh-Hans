...
Customer Journey Analytics 中的 AI 助手是基于其 Adobe Experience League 文档训练的。 被问到问题时，AI 助手会给出有用的回答，有助于快速学习。
...
Data Insights 代理可通过 Customer Journey Analytics 中的 AI 助手访问，它是一个生成式 AI 对话代理，可以快速有效地回答有关您数据的问题。 它使用来自数据视图的组件和您的实际数据在 Analysis Workspace 中构建相关的可视化图表。
...
* **合同访问**：如果您无法使用 AI 助手，请联系您所在组织的管理员或 Adobe 客户代表。 在您的组织可以使用 AI 助手之前，您的组织必须先同意某些与生成式 AI 相关的法律条款。
...
1. 要启动 AI 助手，请在 Customer Journey Analytics UI 中任意页面的顶部标头中选择 AI 助手图标。
