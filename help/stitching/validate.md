...
>[!IMPORTANT]
>
>本文介绍如何验证通过Adobe[请求的](/help/stitching/use-stitching.md)的拼接，并使用添加到重复拼接数据集的拼接身份列实现。 计划不久将更新此文章，其中包含有关如何验证通过连接UI[启用](/help/stitching/use-stitching-ui.md)的拼合的详细信息。
