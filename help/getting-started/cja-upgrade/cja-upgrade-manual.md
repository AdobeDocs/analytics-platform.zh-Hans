...
autotag-review: '2026-05-19T08:14:43.245Z'
TQID: 'https://experienceleague.adobe.com/-vEmQvhPOs0CJHX7175BeF5rYLuYzqaMLCLJFazWDrM'
...
>abstract="此步骤涉及将数据发送到数据流的所有 JavaScript 逻辑。 Adobe 建议维护一份解决方案设计文档，以跟踪 XDM 对象的填充方式。 预计需要花费一个月或更长的时间来建立正确的 JSON 负载值、对其进行测试并将其部署到您的网站上。 由于此步骤需要与您的工程团队不断联系才能完成，因此根据他们的响应能力，可能需要更长的时间。"
