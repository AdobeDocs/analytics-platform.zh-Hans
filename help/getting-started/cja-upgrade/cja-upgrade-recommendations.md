...
1. 在您的Adobe Analytics环境中，[使用Analytics清单](https://experienceleague.adobe.com/en/docs/analytics/admin/admin-tools/analytics-inventory)查看Adobe Analytics环境的全面概述，包括项目和组件数量、报表包数量、用户数量等。
