...
| **[!UICONTROL 报告工具]**： |  |
| **[!UICONTROL 审核日志访问]** | 目前，[审计日志](https://adobe.io/cja-apis/docs/endpoints/auditlogs/)仅通过 API 提供。此权限强制对 API 和即将到来的审核日志 UI 进行权限检查。 |
...
| **[!UICONTROL 筛选器创建]** | 允许用户创建[过滤器](/help/components/filters/filters-overview.md)。 |
