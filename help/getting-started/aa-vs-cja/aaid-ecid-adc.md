...
description: 了解 Analytics Source Connector 如何处理 Adobe Analytics 身份标识字段。
...
## Analytics Source Connector 如何处理这些身份标识

Analytics Source Connector 将这些身份标识以 XDM 形式传递到 Adobe Experience Platform，如下所示：
