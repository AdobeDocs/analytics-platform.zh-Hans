...
| **数据视图间共享的量度和维度** | 允许您[跨多个数据视图](/help/data-views/shared-metrics-dimensions/smd-overview.md)应用维度和量度设置。 对共享维度或量度所做的更改将应用于该维度或量度在所有适用数据视图中的所有实例。 |
...
| **Report Builder** | 通过适用于Microsoft Excel的新Office 365插件支持。 |
