...
| 异常检测 | 全面支持 |
| Attribution IQ | 全面支持 |
| 受众发布 | 全面支持。在 AA 中称为区段发布（将区段从工作区发送到 Experience Cloud）。[受众发布](/help/components/audiences/audiences-overview.md)功能将受众发送到体验平台中的 Real-time Customer Profile。 |
...
| 流媒体分析 | 媒体数据可作为 [Adobe Analytics Source Connector](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=zh-Hans) 的一部分提供。 |
