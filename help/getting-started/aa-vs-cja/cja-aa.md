...
| 提升和置信度报告 | 通过 [实验面板](/help/analysis-workspace/c-panels/experimentation.md) |
...
| 功能 | 注释 |
| --- | --- |
| A4T | 通过 [ Analytics Source Connector](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=zh-Hans) 中的字段提供支持。 |
...
| 新的与重复的会话报告 | 支持 [具有13个月的回顾窗口](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=zh-Hans#new-repeat). |
