...
>[!IMPORTANT]
>
>您必须拥有 **选择** ，以便跨多个报表包执行数据分析。 如果不确定您拥有哪个Customer Journey Analytics包，请联系您的管理员。&#x200B;
...
* [比较通过Analytics Source Connector传递的Analytics数据的术语](/help/getting-started/aa-vs-cja/terminology.md)
