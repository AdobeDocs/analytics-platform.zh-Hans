...
| **[!UICONTROL 数据集类型]** | [数据集类型](create-connection.md#dataset-types)。 类型可以是&#x200B;**[!UICONTROL Event]**、**[!UICONTROL Profile]**、**[!UICONTROL Lookup]**、**[!UICONTROL Summary]**。 临时或关系数据集由&#x200B;**[!UICONTROL （临时）]**&#x200B;或&#x200B;**[!UICONTROL （关系）]**&#x200B;标识。 例如，**[!UICONTROL 事件（临时）]**&#x200B;或&#x200B;**[!UICONTROL 查找（关系）]**。 |
