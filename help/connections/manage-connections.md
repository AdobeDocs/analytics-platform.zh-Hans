...
* 在{➋0}确认&#x200B;**中，在**&#x200B;[!UICONTROL &#x200B;键入连接名称&#x200B;]&#x200B;**中输入连接名称，然后选择**&#x200B;[!UICONTROL &#x200B;删除&#x200B;]&#x200B;**以删除该连接。**&#x200B;选择&#x200B;**[!UICONTROL 取消]**&#x200B;即可取消。
...
>title="核心可报告行数"
>abstract="过去13个月中可用的行总数。 例如，2024 年 2 月 1 日，该数字显示事件时间戳从 2023 年 1 月到 2024 年 1 月的可用行数总数。"
<!-- markdownlint-enable MD034 -->
...
>title="历史可报告行数"
>abstract="超过13个月的时段可用的总行数。 例如，2024 年 2 月 1 日，该数字显示事件时间戳早于 2023 年 1 月的可用行数总数。"
