...
>title="使用Journey Optimizer连接"
>abstract="在Journey Optimizer中利用高级Customer Journey Analytics报告功能。"

>[!CONTEXTUALHELP]
>id="connections_cancel_ajo"
>title="取消Journey Optimizer连接"
>abstract="取消Journey Optimizer的高级Customer Journey Analytics报告功能。"
...
| 列或图标 | 描述 |
| --- | --- |
| **[!UICONTROL _名称_]** | 好记的连接名称。选择超链接名称以查看连接](#connection-details)的[详细信息。 |
...
>title="数据不可用"
>abstract="由于系统限制，2024 年 9 月之前的历史数据不可用。从 2024 年 9 月开始收集和显示量度。该图表在时间线上显示过去 18 个月的数据，未来的数据在数据可用的情况下显示。"
<!-- markdownlint-enable MD034 -->
