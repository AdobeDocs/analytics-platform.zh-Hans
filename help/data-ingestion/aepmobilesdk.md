...
本快速入门指南介绍如何使用Adobe Experience Platform Mobile SDK和Edge Network将移动应用程序跟踪数据直接摄取到Adobe Experience Platform。 然后，在Customer Journey Analytics中使用该数据。
...
3. 在[!UICONTROL 无标题模式]屏幕中：
   ...
   3. 在 [!UICONTROL 添加字段组] 对话框，选择 **[!UICONTROL AEP Mobile SDK ExperienceEvent]** 列表中的字段组。
...
请参阅 [在移动应用程序中实施Adobe Experience Cloud教程](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/overview.html?lang=zh-Hans) 了解更多详细信息。
