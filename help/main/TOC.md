...
user-guide-description: 了解 Adobe Customer Journey Analytics 以及如何将 Analysis Workspace 用于来自 Experience Platform 的数据。
...
+ 组件 {#cja-components}
   ...
   + 计算指标 {#cja-calcmetrics}
      ...
      + 计算指标工作流程 {#cm-workflow}
         ...
         + [生成“每次访问的页面查看次数”指标](../components/calc-metrics/cm-workflow/cm-pvv.md)
