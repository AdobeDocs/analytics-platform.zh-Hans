...
+ Customer Journey Analytics 和 Adobe Analytics {#compare-aa-cja}
   ...
   + 迁移到Customer Journey Analytics {#migrate-to-cja}
      ...
      + [计划用户载入](/help/getting-started/cja-migration/cja-migration-onboarding.md)
      + [端口API使用情况](/help/getting-started/cja-migration/cja-migration-api.md)
      + [替换数据馈送并Data Warehouse](/help/getting-started/cja-migration/cja-migration-export-options.md)
      + [迁移项目和组件](/help/getting-started/cja-migration/cja-migration-projects.md)
...
+ 数据视图 {#cja-dataviews}
   ...
   + [CJA BI扩展](../data-views/bi-extension.md)
...
+ Workspace 项目 {#cja-workspace}
   ...
   + 面板 {#panels}
      ...
      + [“媒体平均受众访问分钟数”面板](/help/analysis-workspace/c-panels/average-minute-audience-panel.md)
...
+ Adobe 集成 {#integrations}
   + [将Adobe解决方案与Customer Journey Analytics集成概述](/help/integrations/overview.md)
   + [将 Adobe Analytics 与 Customer Journey Analytics 集成](/help/integrations/aa.md)
   + [将Journey Optimizer数据与Customer Journey Analytics集成](/help/integrations/ajo.md)
   + [将决策管理数据与Customer Journey Analytics集成](/help/integrations/ajo-od.md)
   + [将客户人工智能与Customer Journey Analytics集成](/help/integrations/customer-ai.md)
