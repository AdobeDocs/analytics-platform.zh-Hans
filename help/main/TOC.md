...
+ 快速入门 {#cja-overview}
  + Customer Journey Analytics {#cja-b2c-overview}
    ...
    + {hide-from-toc}[Analytics产品比较](/help/getting-started/analytics-product-comparison.md)
...
+ 升级和比较 {#compare-aa-cja}
  ...
  + 从Google Analytics 4过渡 {#ga-to-cja}
    + [概述](/help/getting-started/ga-to-cja/home.md)
    + [数据模型](/help/getting-started/ga-to-cja/data-model.md)
    + [报表等效项](/help/getting-started/ga-to-cja/reports.md)
    + [数据差异](/help/getting-started/ga-to-cja/compare-data.md)
...
+ Data mirror {#cja-data-mirror}
  ...
  + [快速入门指南](/help/data-mirror/relational.md)
  + [注意事项](/help/data-mirror/considerations.md)
...
+ 连接 {#cja-connections}
  ...
  + 受众分析 {#audience-analysis}
    + [概述](/help/connections/audience-analysis/audience-analysis-overview.md)
    + [配置](/help/connections/audience-analysis/audience-analysis-configure.md)
...
+ 数据视图 {#cja-dataviews}
  ...
  + 组件设置 {#component-settings}
    ...
    + [重复量度删除](../data-views/component-settings/metric-deduplication.md)
    + [无值选项](../data-views/component-settings/no-value-options.md)
    + [持久性](../data-views/component-settings/persistence.md)
    + {hide-from-toc}[范围](/help/data-views/component-settings/scope.md)
...
+ Workspace 项目 {#cja-workspace}
  ...
  + 可视化图表 {#visualizations}
    ...
    + 自由格式表 {#freeform-table}
      ...
      + [包含多个维度](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
...
+ 组件 {#cja-components}
  ...
  + 受众发布 {#audiences}
    + [受众发布概述](../components/audiences/audiences-overview.md)
    + [创建并发布受众](../components/audiences/publish.md)
    + [管理已发布的受众](../components/audiences/manage.md)
  + 维度 {#dimensions}
  ...
  + 区段 {#segments}
    ...
    + [子事件分析](/help/components/segments/sub-event.md)
  ...
  + 导出 {#exports}
    ...
    + 数据馈送 {#cja-data-feeds}
      ...
      + {hide-from-toc}[在数据馈送中使用派生字段](/help/components/exports/cja-data-feeds/df-derived-fields.md)
...
+ 总人口报表 {#tpr}
  ...
  + {hide-from-toc}[共享查找](/help/tpr/shared-lookups.md)
...
+ 用例 {#cja-usecases}
  ...
  + 复杂的数据 {#complex-data}
    ...
    + [处理无值](../use-cases/data-views/no-value.md)
  + 跨渠道数据 {#cross-channel}
  ...
  + 数据导出 {#data-export}
    ...
    + [Workspace导出](../use-cases/data-export/workspace-export.md)
    + [Report Builder](../use-cases/data-export/report-builder.md)
    + [报表API](../use-cases/data-export/reporting-api.md)
  + 数据摄取 {#data-ingestion}
  ...
  + 数据视图 {#data-views}
    ...
    + BI 扩展 {#bi-extension}
      ...
      + [单一维度排名](/help/use-cases/data-views/bi-extension/single-dimension-ranked.md)
      + [多维度排名](/help/use-cases/data-views/bi-extension/multiple-dimension-ranked.md)
      + [统计不同维度值数量](/help/use-cases/data-views/bi-extension/count-distinct-dimension-values.md)
      + [使用日期范围名称进行筛选](/help/use-cases/data-views/bi-extension/use-date-range-names-to-filter.md)
      + [使用区段名称进行区段划分](/help/use-cases/data-views/bi-extension/use-segment-names-to-segment.md)
      + [使用维度值进行区段划分](/help/use-cases/data-views/bi-extension/use-dimension-values-to-segment.md)
    ...
    + 派生字段 {#derived-fields}
      + [派生字段指南](/help/use-cases/data-views/derived-fields/guidelines.md)
