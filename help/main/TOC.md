...
+ Workspace 项目 {#cja-workspace}
   ...
   + 项目 {#build-workspace-project}
      ...
      + [项目目录](/help/analysis-workspace/build-workspace-project/project-table-of-contents.md)
   ...
   + 可视化图表 {#visualizations}
      ...
      + 自由格式表 {#freeform-table}
         ...
         + [为自由格式表中的维度创建超链接](/help/analysis-workspace/visualizations/freeform-table/freeform-table-hyperlinks.md)
