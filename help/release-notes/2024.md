...
| **Adobe Product Analytics：增强漏斗洞察** | 在 [Friction](https://experienceleague.adobe.com/zh-hans/docs/analytics-platform/using/guided-analysis/funnel/friction) 视图中，书面洞察已得到增强，包括类别、增量和描述，以进一步提高图表和表格的可理解性。 | 2024 年 4 月 17 日 | 2024 年 4 月 26 日 |
