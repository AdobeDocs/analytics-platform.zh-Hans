...
| 功能 | 描述 | [开始推出](releases.md) | [正式发布](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **流媒体收集：将Roku数据发送到Adobe Experience Platform Edge** | 现在，当[使用Experience PlatformEdge](https://experienceleague.adobe.com/zh-hans/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge)安装流媒体收藏集时，您可以使用Adobe Experience Platform Roku SDK将流媒体数据发送到Adobe Experience Platform。 |  | 2024 年 4 月 12 日 |
...
| **流媒体收藏集报表 — 平均受众访问分钟数(AMA)** | CJA 中现已提供“受众平均逗留分钟数”面板。已购买流媒体收藏附加组件的客户可以使用受众平均逗留分钟数面板来更好地了解其内容的平均消费量。受众平均逗留分钟数可以比较任何长度或类型的编程。此外，客户可以将此数字受众平均逗留分钟数与线性电视平均访问分钟数量度进行比较或附加到其上。此面板可更灵活地衡量自定义时段的平均受众以及在事后更新持续时间分类的时间。 |  | 2024 年 3 月 14 日 |
