...
| **Report Builder 中对安全目标的支持** | Report Builder 插件中已添加新的导出目标。 支持以下云存储目标： <ul><li>Amazon S3 角色 ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> |  | 2025 年 6 月 18 日 |
