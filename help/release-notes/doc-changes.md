...
| --- | --- |
| **2025 年 9 月** | |
| 1900年之前的日期 | 添加了有关Customer Journey Analytics如何处理1900年之前的日期的[注释](/help/connections/create-connection.md#datasets)。 |
| 实时报告 | 添加了有关Customer Journey Analytics中[实时报表](/help/components/real-time/real-time.md)的文档。 |
