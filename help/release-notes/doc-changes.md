...
| 流量可视化性能推荐 | 添加了信息来声明，在单个流量可视化图表中扩展10个以上的节点可能会影响报表时间。 |
| 授予Adobe Azure应用程序访问您的密钥的权限的其他方法 | 添加了有关在[为Azure上的Customer Journey Analytics设置客户管理的密钥](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure)时通过授权同意授予权限的信息。 |
| **2025 年 6 月** | |
