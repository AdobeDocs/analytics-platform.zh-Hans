...
Customer Journey Analytics文档自创建以来进行了以下更新。
...
| --- | --- |
| **2023 年 6 月** | |
| 跨渠道分析和拼合 | 为了迎接即将到来的启用拼合的更改以及进一步阐明如何使用拼合提高跨渠道分析功能，我们编辑了与跨渠道分析功能相关的文档，以参阅 [跨渠道分析](../use-cases/cross-channel/cross-channel.md) 作为Customer Journey Analytics功能和用例，以及 [拼接](../stitching/overview.md) 作为完成此任务的重要功能。 |
...
| 计算指标更新 | 已对计算指标文档进行了以下更新，以便使其与当前Customer Journey Analytics功能保持一致： <ul><li>更新了列表 [默认计算量度](/help/components/calc-metrics/default-calcmetrics.md) Customer Journey Analytics中可用</li><li>更新了各种计算指标文章中的屏幕截图和过程 </li></ul> |
| **2023 年 5 月** | |
...
| 优化更新 | 更新文章于 [优化Customer Journey Analytics性能](/help/admin/optimizing-performance.md) |
...
| 项目过滤器（临时过滤出和快速过滤器） | 简化了有关项目筛选器的文档，并删除了重复信息。 创建临时过滤器的步骤现在与[创建快速过滤器](/help/components/filters/quick-filters.md)的步骤合并在一起。 |
| **2023 年 3 月** | |
| 集成决策管理数据 | 添加了说明如何 [将Adobe Journey Optimizer Decision Management数据集成到Customer Journey Analytics中](/help/integrations/ajo-od.md). |
| 在移动记分卡中创建数据故事 | [数据故事](/help/mobile-app/create-scorecard.md#create-data-stories)是围绕中心主题或指标构建的辅助数据点、业务背景和相关指标的集合。 |
| 更新了功能支持 | 已更新 [Customer Journey Analytics功能支持](/help/getting-started/aa-vs-cja/cja-aa.md) 包含Customer Journey Analytics中可用，但在AA中不可用或不受支持的功能表。 |
| 默认计算指标 | 添加了解释 [Adobe 提供的默认计算指标](/help/components/calc-metrics/default-calcmetrics.md)的内容。 |
...
| 对 Audiences 文档的更新 | 创建受众后，Adobe会创建一个Experience Platform [每个新Customer Journey Analytics受众的流区段](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=zh-Hans#after-audience-created). |
| 工作区日历和日期范围 | 更新内容以描述相对日期范围、公式计算更新和日程表 UI 更改。请参阅[关于相对面板日期范围](/help/components/date-ranges/calendar.md#relative-panel-dates)。 |
| 移动记分卡 | 新文档部分描述如何显示和隐藏比较日期范围。参见 [显示比较日期范围](/help/mobile-app/create-scorecard.md#show-comparison-dates) 在Customer Journey Analytics中。 |
| **2023 年 1 月** | |
...
| 数据摄取快速入门指南 | 新增文档部分，介绍如何 [摄取和使用数据](/help/data-ingestion/data-ingestion.md) 在Customer Journey Analytics中。 |
...
| 对象数组支持配置文件和查找数据集 | 已更新 [使用对象数组](/help/use-cases/object-arrays.md) 和 [摄取Adobe Experience Platform受众](/help/use-cases/data-ingestion/ingest-aep-segments.md) 以反映对配置文件和查找数据集的对象数组支持。 |
...
| --- | --- |
| **2022 年 12 月** |  |
| 2022 年 12 月 16 日 | 有关的新主题 [衡量和管理Customer Journey Analytics数据使用情况](/help/admin/estimate-usage.md). |
| **2022 年 10 月** | |
...
| 2022 年 10 月 | 有关的新主题 [Customer Journey Analytics审核日志](/help/privacy/audit-log.md). |
...
| **2022 年 9 月** | |
| 2022 年 9 月 | 上的新用例 [将Google Analytics数据迁移到Customer Journey Analytics](/help/use-cases/ga/overview.md). |
...
| 2022 年 8 月 | 有关以下内容的重要更新文章： [Customer Journey Analytics访问控制](/help/admin/cja-access-control.md). |
| 2022 年 8 月 | 关于以下内容的新文章： [Customer Journey Analytics支持“数据管理”标签和策略](/help/data-views/data-governance.md). |
...
| 2022 年 6 月 | 关于以下内容的新文章： [跨Adobe Analytics和Customer Journey Analytics报表功能比较数据处理](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| 2022 年 6 月 | 关于以下内容的新文章： [Customer Journey Analytics中的Analytics Labs](/help/labs/labs.md). |
...
| **2022 年 5 月** | |
| 2022 年 5 月 | 有关以下内容的重要更新文章： [创建连接](/help/connections/create-connection.md) 在Customer Journey Analytics中。 |
| 2022 年 5 月 | 关于如何操作的新文章 [管理Customer Journey AnalyticsReport Builder中的数据块](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=zh-Hans). |
| 2022 年 5 月 | 关于以下内容的新文章： [将Adobe Experience Platform受众引入Customer Journey Analytics](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **2022 年 4 月** | |
...
| 2022 年 4 月 | 新 [适用于Adobe Analytics用户的Customer Journey Analytics用户指南](/help/getting-started/aa-to-cja-user.md). |
| **2022 年 3 月** | |
| 2022 年 3 月 | 新 [Customer Journey Analytics批注API文档](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **2022 年 2 月** | |
| 2022 年 2 月 | 面向从Adobe Analytics迁移至Customer Journey Analytics的管理员的新指南： [Adobe Analytics到Customer Journey Analytics的演变](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=zh-Hans) |
| **2022 年 1 月** | |
| 2022 年 1 月 | 的新用例 [在Customer Journey Analytics中使用绑定维度和量度](/help/use-cases/data-views/binding-dimensions-metrics.md) |
...
| 2022 年 1 月 | 关于以下内容的新文章： [将Adobe Analytics数据与Customer Journey Analytics中的Analytics数据进行比较](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=zh-Hans) |
...
| **2021 年 10 月** | |
| 2021 年 10 月 | 以下项的文档 [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=zh-Hans#) 在Customer Journey Analytics中。 |
...
| 2021 年 9 月 | 关于的新部分 [合并报表包的影响](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=zh-Hans#6。-considerations-when-merging-report-suites-in-cja) 在Customer Journey Analytics中。 |
| **2021 年 8 月** | |
| 2021 年 8 月 | 关于增强功能的新部分 [连接](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=zh-Hans) Customer Journey Analytics体验。 |
...
| 2021 年 4 月 | 有关的新主题 [Customer Journey Analytics中的高基数维度](/help/components/dimensions/high-cardinality.md). |
| **2021 年 3 月** | |
...
| 2021 年 2 月 | 已发布新 [CUSTOMER JOURNEY ANALYTICSAPI](https://www.adobe.io/cja-apis/docs/) 文档。 |
| **2021 年 1 月** | |
...
| 2019 年 12 月 | Customer Journey Analytics文档初稿 |
