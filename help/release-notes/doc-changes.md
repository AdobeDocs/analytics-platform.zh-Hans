...
| --- | --- |
| **2025 年 10 月** | |
| 关于LLM和AI生成的流量的报告 | 添加了有关如何使用派生字段作为基础来报告LLM和AI生成的流量的[用例文章](/help/use-cases/ai-traffic.md)。 本文是基于博客文章[在Adobe Customer Journey Analytics中跟踪和分析LLM和AI生成的流量](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics-blogs/tracking-and-analyzing-llm-and-ai-generated-traffic-in-adobe/ba-p/771967)。 |
| **2025 年 9 月** | |
