...
| --- | --- |
| **2023 年 6 月** |  |
| 计算量度更新 | 已对计算指标文档进行了以下更新，以便使其与当前CJA功能保持一致： <ul><li>更新了列表 [默认计算量度](/help/components/calc-metrics/default-calcmetrics.md) 在CJA中可用</li><li>更新了各种计算量度文章中的屏幕截图和程序 </li></ul> |
| **2023 年 5 月** |  |
