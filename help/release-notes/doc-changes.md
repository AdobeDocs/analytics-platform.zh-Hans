...
| --- | --- |
| **2025 年 9 月** | |
| 使用界面 | 添加了关于连接中更新的[使用接口](/help/connections/manage-connections.md#usage)的文档。 |
| 拼合Journey Optimizer数据集 | 记录了自动生成的[可用于拼合的历程优化器数据集](/help/stitching/overview.md#journey-optimizer-datasets)列表。 |
