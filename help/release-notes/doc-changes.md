...
| --- | --- |
| **2025 年 5 月** | |
| 验证拼接 | 向[验证](/help/stitching/validate.md)添加了标识拼接如何影响身份验证成功率和总体人员识别性能的文档。 |
| “事件深度”维度 | 作为数据视图[标准维度](/help/components/dimensions/overview.md#standard-dimensions)的一部分的新事件深度维度的文档。 |
| **2025 年 4 月** | |
...
| **2024 年 8 月** | |
| B2B 项目示例 | 新增了一个[用例](/help/use-cases/b2b/example.md)，详细描述了如何在 Customer Journey Analytics 中使用新的[转换数据集进行 B2B 查找](/help/connections/transform-datasets-b2b-lookups.md)功能，设置、配置和报告基于配置文件（人员）级别的 B2B 数据。 |
...
| 2022 年 8 月 | 关于[将受众发布到实时客户配置文件](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html?lang=zh-hans)的新文档。 |
| **2022 年 7 月** | |
