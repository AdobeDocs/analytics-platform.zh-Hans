...
| --- | --- |
| **2025 年 9 月** | |
| 上下文标签 | 添加了关于数据视图组件中[上下文标签](/help/data-views/component-settings/overview.md#context-labels)的使用和用途的更多背景信息。 |
| **2025 年 8 月** | |
| 与Adobe Advertising的新集成 | 添加了有关[与Adobe Advertising](/help/integrations/advertising.md)集成的信息。 |
