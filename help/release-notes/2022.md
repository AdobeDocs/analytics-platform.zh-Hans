...
| Analytics Source Connector 的数据准备 | [Analytics Source Connector](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html?lang=zh-Hans) 现已与 Adobe Experience Platform 提供的[数据准备](https://experienceleague.adobe.com/docs/experience-platform/data-prep/home.html?lang=zh-Hans) 功能集成。Adobe Real-time Customer Data Platform (RTCDP)、Customer Journey Analytics和Adobe Journey Optimizer客户现在可以使用其他字段组扩展Analytics字段组。 他们还可以利用100多个数据准备操作员，在将数据摄取到Adobe Experience Platform期间扩充Analytics数据。 RTCDP客户现在可以为配置文件启用多个支持数据准备的报告包。<p>现在，通过Analytics Source Connector摄取多个报告包的Customer Journey Analytics客户可以在报告包之间取消对列差异的冲突。 例如，如果“搜索词”存储在 `eVar1` 在一个报告包中 `eVar2` 在另一个报告包中，使用数据准备，您可以通过合并两个eVar中的值的新列来扩展Analytics字段组。 | 2022 年 4 月 27 日 |
