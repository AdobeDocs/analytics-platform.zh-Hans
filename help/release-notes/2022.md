...
| **计划项目的密码保护** | 此功能是 HIPAA 就绪的一部分，仅适用于 Healthcare Shield 客户。[了解详情](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/curate-share/t-schedule-report.html?lang=zh-Hans#password) | 不适用 | 2022 年 11 月 7 日。 |
