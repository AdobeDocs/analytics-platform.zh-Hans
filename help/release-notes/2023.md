...
| **边缘网络设备查找** | 通过Experience Platform边缘网络启用自动设备类型数据收集。 此服务使Customer Journey Analytics与其他Experience Platform应用程序一起受益。 [了解详情](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | 不适用 | 2023 年 9 月 27 日 |
...
| **Edge Network地理查找** | 您可以在Customer Journey Analytics中使用地理位置数据。 在数据流设置中启用此功能。 [了解详情](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-network-lookup) |  | 2023 年 7 月 26 日 |
