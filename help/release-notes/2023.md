...
| **Adobe Product Analytics - 仅限 Private Beta 访问** | 2023 年 3 月 21 日，Adobe 宣布推出 Adobe Product Analytics，这是一种与 Customer Journey Analytics 中的跨渠道数据和洞察进行交互的新方式。这些新功能使产品团队能够通过引导式分析工作流程自助提供有关其产品体验的数据和洞察。团队可以：<ul><li>了解用户参与在一段时间内的模式</li><li>分析用户群的增长</li><li>找出一连串步骤中出现分歧的部位</li><li>衡量功能发布的影响</li><li>发现有意义的细分市场，以便在这些细分市场与产品的整个历程中参与和培养</li><li>在 Analysis Workspace 中打开以进行更深入的分析以及与分析师的协作等等！</li></ul>如果您是 Customer Journey Analytics 客户并且有兴趣加入 Private Beta，请联系您的 Adobe 帐户团队。[了解详情](https://business.adobe.com/products/product-analytics/adobe-product-analytics.html) | 不适用 | 2023 年 7 月 17 日 |
