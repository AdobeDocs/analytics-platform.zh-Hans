...
* **转出开始**:从内部Adobe用户进行有限测试开始，逐步推出分阶段发布。 然后，该版本在几个月内将对客户的可用性从0%扩展到100%。 由于分阶段推出在 Experience Cloud 组织级别进行，因此组织中所有授权用户都可以获得相同的体验。
...
| 问题 | 回答 |
| --- | --- |
| 我是否可以请求提前访问某个功能？ | 不会。不会授予提前访问权限。<br>如果您想要提前测试 Analytics 概念，我们建议您试用 [Adobe Analytics Labs](https://experienceleague.adobe.com/docs/analytics/analyze/labs.html)，就我们行业领先的创新技术提供反馈。 |
