...
| **查找和配置文件数据的行数量度** | 作为连接的一部分配置的数据集的行计数量度现在包括添加、跳过或从配置文件和查找数据集中删除的记录。 |  | 2024 年 2 月 14 日 |
...
| **Adobe Product Analytics：与任何人共享** | 使您可与无权访问 Product Analytics 的人士共享 Adobe Product Analytics 项目的只读链接。 |  | 2024 年 2 月 21 日 |
