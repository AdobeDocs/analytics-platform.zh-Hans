...
| **工作区项目的目录** | 现在有新的目录可用于项目。 目录提供了使用户能够快速跳转到项目中的面板和可视化图表的链接。 <p>该目录在所有项目的左边栏中均可用。</p><p>有关更多信息，请参阅 [项目目录](/help/analysis-workspace/build-workspace-project/project-table-of-contents.md). |  | 2024年6月19日 |
