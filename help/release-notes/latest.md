...
| **有关 Analysis Workspace 性能中的请求因素的新信息** | 在 Analysis Workspace 中分析性能时，现在可以使用新的“请求因素”部分。要深入了解请求的处理方式以及影响处理时间的各种因素，请参阅[优化 Analysis Workspace 性能](https://experienceleague.adobe.com/en/docs/analytics-platform/using/technotes/optimizing-performance#request-factors)中的“请求因素”部分。 |  | 2024 年 10 月 1 日 |
