...
| **B2B 模板** | 如果您获得 Customer Journey Analytics B2B Edition 的许可证，就可以从 Adobe 模板 UI 中获取以下额外的 B2B 模板： <ul><li>B2B 帐户参与度概述</li><li>B2B 机会参与度概述</li><li>B2B 购买群组活动</li></ul><p>（文档链接见下文。）</p> |  | 2025 年 8 月 15 日 |
