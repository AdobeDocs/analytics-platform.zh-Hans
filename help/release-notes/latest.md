...
# 当前的 Adobe Customer Journey Analytics 发行说明（2023 年 10 月/11 月）


**上次更新日期**：2023 年 10 月 26 日

这些发行说明涵盖 2023 年 10 月 16 日至 2023 年 11 月末的发行期。Adobe Customer Journey Analytics 版本在[持续投放模型](releases.md)上运行，通过该模型可采用更具可扩展性、分阶段的方法部署功能。因此，这些发行说明每月更新几次。请定期检查。

## 新增功能或更新后的功能

| 功能 | 描述 | [开始推出](releases.md) | [正式发布](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Adobe Product Analytics 中的[!UICONTROL 用途]视图的新功能** | 已将以下功能添加到[用途](/help/guided-analysis/types/usage.md)视图：<ul><li>**趋势线**：现在支持趋势线。在图表上方单击[!UICONTROL 叠加]以启用这些趋势线。</li><li>**查询细分**：您现在可以将细分应用于此视图类型。它们可用作查询边栏中的选项。</li></ul> | 不适用 | 2023 年 10 月 25 日 |
