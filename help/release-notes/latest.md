...
| **在Adobe Journey Optimizer中使用Customer Journey Analytics数据视图** | Customer Journey Analytics中新增的配置选项允许您指定要与Adobe Journey Optimizer一起使用的Customer Journey Analytics数据视图，而无需手动配置。 <!-- add this in: <p>For information about how to enable this configuration option, see the [Compatibility](/help/data-views/create-dataview.md#compatibility) section in [Create or edit a data view](/help/data-views/create-dataview.md).</p> --><p>以前，在Customer Journey Analytics中查看Adobe Journey Optimizer数据时，您必须手动配置连接和数据视图。</p><p>（文档链接见下文）</p> |  | 2024年6月19日 |
