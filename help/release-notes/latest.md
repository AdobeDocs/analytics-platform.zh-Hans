...
| **B2B查找数据集的转换** | 您现在可以 [转换B2B查找数据集](/help/connections/transform-datasets-b2b-lookups.md) 定义连接时。 此转换允许对B2B数据支持基于人员的查找。 | | 2024年6月6日 |
...
| **派生字段 — 新函数和函数模板** | 其他派生字段函数([数学](/help/data-views/derived-fields/derived-fields.md#math)， [下一个或上一个](/help/data-views/derived-fields/derived-fields.md#next-or-previous))和 [函数模板](/help/data-views/derived-fields/derived-fields.md#function-templates). | | 2024 年 6 月 5 日 |
...
| **新增有关数据导出用例的文档** | 此新部分概述 [数据导出用例](https://experienceleague.adobe.com/zh-hans/docs/analytics-platform/using/cja-usecases/data-export/overview) 例如<ul><li>数据备份</li><li>数据验证</li><li>数据湖、数据仓库或 BI 工具</li><li>为 AI/ML 做好准备</li></ul> 以及如何使用 Experience Platform 和 Customer Journey Analytics 功能实现它们。 | | 现在可用 |
