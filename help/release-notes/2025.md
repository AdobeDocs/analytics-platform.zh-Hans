...
| **B2B 模板** | 如果您获得 Customer Journey Analytics B2B Edition 的许可证，就可以从 Adobe 模板 UI 中获取以下额外的 B2B 模板： <ul><li>B2B 帐户参与度概述</li><li>B2B 机会参与概述</li><li>B2B 购买群组活动</li></ul><p>有关详细信息，请参阅[使用模板](/help/analysis-workspace/templates/use-templates.md#b2b-templates)中的 [B2B 模板](/help/analysis-workspace/templates/use-templates.md)。</p> |  | 2025 年 8 月 15 日 |
...
| **Report Builder 现已支持安全云目标** | 您现在可以将报告从 Report Builder 导出到以下云存储目标：<ul><li>Amazon S3 角色 ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul><p>此前，您可以通过电子邮件将工作簿共享给其他用户，但无法将 Report Builder 中的报告导出至云目标。</p><p>有关详细信息，请参阅[通过导出到云目标来安排工作簿](/help/report-builder/report-builder-export.md)。</p> |  | 2025 年 6 月 19 日（原定 2025 年 6 月 18 日） |
