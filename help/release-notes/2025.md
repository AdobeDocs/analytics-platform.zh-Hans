...
| **支持临时架构和关系架构** | 在Experience Platform的数据摄取和数据镜像工作流中使用[临时](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/xdm/tutorials/ad-hoc)和[关系架构](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/xdm/schema/relational)。 |  | 2025 年 9 月 23 日（原计划于 2025 年 8 月 28 日发布） |
