...
![转化趋势](/help/assets/icons/ConversionTrends.svg) **[!UICONTROL 转化趋势]**&#x200B;视图提供了转化率随时间变化的趋势可视化图表。 水平轴是一个时间间隔，而垂直轴表示转化率。
...
* **跟踪优化工作**：在识别要使用[摩擦](funnel.md)改进的关键瓶颈后，您可以使用此视图来跟踪这些优化如何随时间影响转化率。
...
* **[!UICONTROL 视图]**：在此视图类型和[摩擦](funnel.md)之间切换。
...
>[!NOTE]
>
>“转化趋势”视图表中的&#x200B;**平均**&#x200B;列与[摩擦视图](funnel.md)表中的&#x200B;**总计**&#x200B;列不同。 前者是间隔列的平均值（例如，每日转化率的平均值），而后者是整个日期范围内的汇总计算。
