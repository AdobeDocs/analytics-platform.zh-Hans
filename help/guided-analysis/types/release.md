...
**[!UICONTROL 版本]**&#x200B;视图显示给定日期之前和之后关键指示器执行情况的比较。 此报告的水平轴是一个时间间隔，而垂直轴测量所需的关键指标。 图表中间有一个垂直条形图，表示要在前后比较的日期。 此日期通常表示要衡量的产品发生了显着更改，例如产品更新或促销活动启动。
...
* **[!UICONTROL 视图]**：在此视图类型和[首次使用](first-use.md)之间切换。
