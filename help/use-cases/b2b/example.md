...
请参阅 [添加和配置数据集](../../connections/create-connection.md) 有关如何配置数据集设置的详细信息。
...
本节提供了有关在定义 [组件](../../data-views/create-dataview.md#components) 的页面。

对于每个组件，提供了名称、架构路径以及有关配置的详细信息（如果适用）。


### B2B活动数据集

B2B活动数据集包含相关的体验事件，是连接的一部分必需的。
