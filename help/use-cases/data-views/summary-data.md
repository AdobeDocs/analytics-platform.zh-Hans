...
[![DataDownload](/help/assets/icons/DataDownload.svg)下载示例摘要数据](./assets/summary-data.csv)
...
[![DataDownload](/help/assets/icons/DataDownload.svg)下载示例事件数据](./assets/event-data.csv)
...
1. 从![应用程序](/help/assets/icons/Apps.svg)应用程序切换器中选择&#x200B;**[!UICONTROL Experience Platform]**。
...
1. 从![应用程序](/help/assets/icons/Apps.svg)应用程序切换器中选择&#x200B;**[!UICONTROL Customer Journey Analytics]**。
...
1. 选择![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL Add]**&#x200B;以添加另一个新的计算量度。
   ...
   1. 使用![事件](/help/assets/icons/Event.svg) **[!UICONTROL 收入（最近联系） | 30天)]** **[!UICONTROL −]** ![事件](/help/assets/icons/Event.svg) **[!UICONTROL 费用]**&#x200B;作为&#x200B;**[!UICONTROL 定义]**。
   1. 选择&#x200B;**[!UICONTROL 保存]**。
