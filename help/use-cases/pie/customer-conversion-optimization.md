...
品牌通常将总体转化率视为成功的滞后指标，并专注于转化率优化以增加展示次数。 但转化率是所有虚指标中的王；它可能表示短期的胜利，但通过将数量置于客户体验质量之上，您可能会对品牌造成长期损害。

## 用例概述

客户转化优化用例的主要目标是推进当前处于考虑阶段的前景成为转化客户。 为了实现这种提升，您需要考虑每个客户的转化需求，而不是只查看汇总转化率。

### 和老家伙一起出去

许多组织在了解宏观层面的转化时（例如创收事件），如果与任何类型的转化事件的成因相结合，将不断面临挑战。 对于微观和纳米客户而言，很难针对不同的同类群组启动有针对性的促销活动来推动注册和转化。

典型的转化优化策略还被单独限制在数字渠道，例如Web或移动设备。 由于缺乏在其他接触点上的客户互动知识，品牌很难规划有影响力的多渠道体验，以指导人员从考虑因素到转化。 因此，它们可能会继续提供无关紧要或陈旧的信息传递，进一步冒着品牌长期受损的风险。

### 使用新的

通过客户转化优化，品牌可以将当前处于考虑阶段的目标客户转化为已转化的客户。 互联转化优化工具一对一地分析每个潜在客户的体验，并相应地改进其独特体验。 通过关注每个用户的历程并专注于单个客户的成功，您可以：

* 通过特征和行为数据分析令人兴奋体验的所有上下文驱动因素，以改进转化事件。
* 对尚未注册或转换的假名配置文件使用高级分段和激活工具。
* 使用兴趣和首选渠道创建个性化设置，从而在广告、社交、电子邮件、文本等多个领域一对一扩展体验。
* 使用AI建模来识别指标并将用户路由到最佳路径，例如免费试用或聊天。

客户转化优化关乎平衡。 短期成功指标（如转化率）很重要，但长期指标（如忠诚度、终生价值、品牌情绪和净推广者得分）是确保品牌有一个光明和可持续的未来的因素。

因此，不要试图从广泛的细分市场产生相同的转化事件，而要专注于建立持久的一对一客户关系，并分析成功的信号和模式。 作为以客户体验为中心的战略的副产品，您的转化率会自然而然地提高。

### 目标、挑战和独特之处

客户转化优化用例解决了尝试实现目标时的许多常见挑战。 Adobe的Real-time Customer Data Platform、Journey Optimizer和Customer Journey Analytics等应用程序及其底层功能的组合在克服这些挑战方面与众不同。

| 目标 | 挑战 | 差异 |
|---| ---|---|
| **构建深 <br/>了解<br/>每个人<br/>潜在客户历程<br/>和体验。** | 大多数组织都面临着理解宏观层面的转化（创收事件）的挑战。 然后，将该宏级别转化与任何类型的转化事件的影响因素配对。<br/><br/>转换优化还被单独限制在数字渠道（例如Web或移动设备）。 | Adobe提供一套更加全面且以客户为中心的应用程序，使品牌厂商能够分析有助于提供积极且引人入胜的体验的所有情境驱动因素。 然后，在对于各个渠道的每个客户都重要的转化事件中推动巨大的改进。<br/><br/>可在整个历程中对见解进行操作，以使用特征和行为数据优化体验 |
| **识别和分析<br/>信号和意图<br/>每个潜在客户的<br/>转化需求。** | 很难通过微观和纳米区段客户为不同的同类群组启动有针对性的促销活动来推动注册或转化<br/><br/>品牌厂商很难使用匿名行为来计划跨渠道的有影响力的体验。 | Adobe允许对尚未注册或转换的假名配置文件进行高级分段和激活功能。<br/><br/>随着用户逐步完成考虑转化的过程，Adobe应用程序可以共同创建跨广告、社交、电子邮件、文本等的互联全渠道体验。 |
| **参与和<br/>对每一个进行个性化<br/>潜在客户<br/>规模化。** | 由于缺乏对其他渠道客户互动的了解，导致报文传送不相关或陈旧，并有可能对品牌造成长期经济损害。<br/><br/>随着用户逐步完成考虑到转化的各个阶段，很难保持内聚和相互关联的体验 | 通过促进一对一个性化的全渠道营销，承认客户的兴趣并吸引他们进入其首选渠道，开始客户使用您的品牌之旅<br/><br/>使用AI建模智能地识别指标，并将每个用户路由到最佳路径，如试用下载或聊天。 |
...
Use Al/ML to measure the sales impact of marketing across all channels.
...
The Commoditization of online buying has eroded traditional advantages.
...
Real-time Customer Data Platform可帮助您细分和激活处于考虑阶段的用户。 Real-time Customer Data Platform利用高级分段功能和AI来分析行为数据。 您可以获得最佳体验机会的倾向分数，以推动注册和转化。
