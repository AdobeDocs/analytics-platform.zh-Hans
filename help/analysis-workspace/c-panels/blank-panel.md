...
*本文以&#x200B;**Customer Journey Analytics**记录空白面板。<br/>查看本文的&#x200B;**Adobe Analytics**版本的[空白面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/blank-panel)。*
