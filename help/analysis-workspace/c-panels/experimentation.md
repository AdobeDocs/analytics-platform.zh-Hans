...
*本文以&#x200B;**Customer Journey Analytics**记录了“试验”面板。<br/>有关如何在&#x200B;**Adobe Analytics**中分析Adobe Target活动和体验的信息，请参阅[Analytics for Target面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/a4t-panel)。*
