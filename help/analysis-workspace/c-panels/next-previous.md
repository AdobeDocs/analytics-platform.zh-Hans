...
*本文记录了&#x200B;**Customer Journey Analytics**中的下一个或上一个项目面板。<br/>查看本文的&#x200B;**Adobe Analytics**版本的[下一个或上一个项目面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/next-previous)。*
