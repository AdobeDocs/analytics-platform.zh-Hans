...
>abstract="只要您在 Analysis Workspace 中看到数据，就可以全表导出。 您可以根据需要创建或计划完整表导出。<br><br>如果您已明确需要导出的数据内容，只需几分钟即可创建完整表导出。"

<!-- markdownlint-enable MD034 -->

在Customer Journey Analytics中，您可以将完整表从Analysis Workspace导出到指定的云目标。
...
[完全表导出的优点](#advantages-of-full-table-export)包括能够导出数百万行，包括计算量度，以串联值输出结构数据，等等。

导出完整表格时，请考虑以下事项：

* 在导出到云之前，请确保您的表、环境和权限符合[最低导出要求](#minimum-requirements)。
...
1. [从工作区导出完整表格](#export-full-tables)
...
>title="通知"
>abstract="添加用户和用户组，以便在导出失败或即将过期时接收通知。"
...
1. 如果尚未配置，请按照[配置云导出帐户](/help/components/exports/cloud-export-accounts.md)和[配置导出位置](/help/components/exports/cloud-export-locations.md)中的说明配置导出帐户和位置。

1. 在Analysis Workspace中，右键单击自由格式表的标题以显示上下文菜单，然后选择&#x200B;[!UICONTROL **导出完整表**]。

   ![突出显示了“导出完整表”的自由格式表上下文菜单。](assets/export-full-table.png)
...
1. 在&#x200B;[!UICONTROL **新建完整表格导出**]&#x200B;对话框中，指定以下信息：
   ...
   | 标记 | 您可以将现有标记应用于导出内容，也可以创建新标记并应用它。 <p>要将现有标记应用于导出内容，请从下拉菜单中选择任意标记。您公司中的任何标记均可供应用。</p> <p>要创建新标记，请键入新标记的名称，然后按 Enter。</p><p>在导出内容中应用标记时，请考虑以下事项： <ul><li>您应用的标记可以在导出表中进行过滤或搜索。</li> <li>导出完整表格时，应用于项目的标记不会自动应用，如[管理导出内容](/help/components/exports/manage-exports.md)中的“在导出页面上配置列”中所述。（或者，当[计划导出完整项目](/help/analysis-workspace/export/t-schedule-report.md)时，应用于该项目的任何标记将自动应用于导出。） </li></ul> |
   ...
   | 数据结构 | 显示您正在导出的自由格式表。您可以通过将组件从左侧面板拖动到表格中来调整数据结构。您可以将组件拖动到筛选区域以应用筛选条件。在将组件添加到画布时，表格会动态更新。 您最多可以包含10列。<p>应用于项目中完整表格的任何区段都会显示在表格上方。 您可以将区段或区段组应用到导出。</p> |
   ...
   | 通知 | 添加希望在此导出失败或即将过期时接收通知的用户和组。 开始键入用户的名称或电子邮件地址，或开始键入组的名称，然后将其添加到下拉列表中。 |
...
1. （可选）创建导出后，无论您选择立即发送还是按照定义的计划发送，您都可以在[导出页面](/help/components/exports/manage-exports.md)上查看和管理它，并在[导出日志](/help/components/exports/manage-export-logs.md)中查看它。
...
* 以CSV、JSON或Parquet格式导出文件。 （[其他导出选项](/help/analysis-workspace/export/export-project-overview.md)也提供该功能。）
...
| 基本功能 | 支持状态 |
|---------|----------|
| 绝对值 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 列最大值 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 列最小值 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 列总和 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 计数 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 指数 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 平均值 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 中间值 | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 取模 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 百分位数 | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 幂运算符 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 四分位数 | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 行计数 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 行最大值 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 行最小值 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 行总和 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 轮次 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 平方根 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 标准偏差 | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 变量 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
...
| 高级功能 | 支持状态 |
|---------|----------|
| 以10为底的对数（指数代数） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 立方根（指数代数） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 自然对（指数代数） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| Floor（数值调整代数） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |

#### 逻辑函数

| 高级功能 | 支持状态 |
|---------|----------|
| If（逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |

#### 布尔函数

| 高级功能 | 支持状态 |
|---------|----------|
| Not（布尔运算符逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| Or（布尔运算符逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| And（布尔运算符逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |

#### 比较函数

| 高级功能 | 支持状态 |
|---------|----------|
| 小于（比较逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 小于或等于（比较逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 等于（比较逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 大于或等于（比较逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 大于（比较逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 不等于（比较逻辑） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
...
| 高级功能 | 支持状态 |
|---------|----------|
| Pi | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 正弦（标准） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 余弦（标准） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 正切（标准） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 反正弦（标准） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 反余弦（标准） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 反正切（标准） | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |

#### 双曲函数

| 高级功能 | 支持状态 |
|---------|----------|
| 双曲余弦 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 双曲正弦 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |
| 双曲正切 | 支持![StatusGreen](/help/assets/icons/StatusGreen.svg) |

#### WASKR函数

| 高级功能 | 支持状态 |
|---------|----------|
| 置信度(WASKR) | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 置信度（下限） (WASKR) | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 置信度（上限） (WASKR) | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |

#### 分布函数

| 高级功能 | 支持状态 |
|---------|----------|
| T分数（学生T分布） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| T检验（学生T分布） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| CDF-T（学生T-Distribution） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| Z分数（正态分布） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| Z检验（正态分布） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| CDF-Z（正态分布） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |

#### 回归函数

| 高级功能 | 支持状态 |
|---------|----------|
| 相关系数（指数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 截距（指数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 预测的Y（指数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 斜率（指数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 相关系数（线性回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 截距（线性回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 预测的Y（线性回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 斜率（线性回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 相关系数（对数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 截距（对数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 预测的Y（对数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 斜率（对数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 相关系数（幂回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 截距（幂回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 预测的Y（幂回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 斜率（幂回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 相关性（二次回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 截距（二次回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 预测的Y（二次回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 斜率（二次回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 相关系数（倒数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 截距（倒数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 预测的Y（倒数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |
| 斜率（倒数回归） | 不支持![StatusRed](/help/assets/icons/StatusRed.svg) |

#### 其他高级功能

| 高级功能 | 支持状态 |
|---------|----------|
| 非重复近似计数 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
| 累积 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
| 累积平均数 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
| 提升 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
| 样本方差 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
