...
>abstract="只要您在分析工作区中看到数据，就可以完整表格导出。 您可以根据需要创建或计划全表导出。<br><br>如果您已经知道导出中要包含哪些数据，您只需几分钟就可创建完整表格导出。"
...
>title="计划"
>abstract="选择导出的执行频率。 选择“立即发送（单次）”以立即启动导出。 计划导出将在您指定的日期和时间自动启动。"
...
| 累积平均 | ![蓝状态](/help/assets/icons/StatusBlue.svg)已计划 |
