...
1. 在&#x200B;[!UICONTROL **新建完整表导出**]&#x200B;对话框中，指定以下信息：
   ...
   | 回顾窗口 | 选择要包含在每个导出文件中的报表时间范围。 选项包括&#x200B;[!UICONTROL **今天**]、[!UICONTROL **昨天**]、[!UICONTROL **最近7天**]、[!UICONTROL **最近30天**]、[!UICONTROL **本周**]&#x200B;和&#x200B;[!UICONTROL **本月**]。 <p>当&#x200B;[!UICONTROL **导出频率**]&#x200B;设置为&#x200B;[!UICONTROL **立即发送（一次性）**]&#x200B;时，不显示此选项。 |
