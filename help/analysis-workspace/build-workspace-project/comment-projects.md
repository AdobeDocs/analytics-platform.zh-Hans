...
在项目[&#128279;](#comment-on-a-specific-area-of-the-project)的特定区域上作出的评论具有在评论所属的项目区域上显示的&#x200B;**评论徽章** ![评论徽章](assets/comment-indicator.svg)。 选择徽章以查看评论。 选择徽章后，您可以选择注释本身以在右边栏的注释区域中突出显示注释。
