...
| 元素 | 描述 |
|---|---|
| [新建项目](/help/analysis-workspace/home.md) | 单击此链接可从头开始或从为您创建的[template](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=en#analysis-workspace)开始新项目。 |
...
在项目中，该菜单提供了用于管理项目、添加组件、查找帮助等的选项。 每个菜单选项也可通过键盘[快捷键](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.html)进行访问。
...
根据您为项目选择的起点，画布中将显示[自由形式表](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table.html)或[空白面板](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/blank-panel.html)。 开始分析的最快捷方式是选择一个或多个组件，然后将它们拖放到项目画布中。 将自动为您呈现数据表。 [进一](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table.html) 步了解构建表的不同选项，或利用我们的培训教 [程](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?#training-tutorial) ，进一步指导您构建第一个项目。

![](assets/canvas.png)

## 项目经理 {#manager}

Analysis Workspace项目可以在&#x200B;**Analytics > Components > Projects**&#x200B;下进行管理。 项目经理会显示特定用户已创建的项目。 项目所有权可以在“管理员”>“分析用户和资产”>“转移资产”下转移给新用户。
