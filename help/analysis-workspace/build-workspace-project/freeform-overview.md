...
| ![共享](/help/assets/icons/ShareAlt.svg) | **[!UICONTROL 共享]** | 共享项目。 请参阅[共享项目](/help/analysis-workspace/curate-share/share-projects.md)，以了解更多信息。 |
| ![编辑](/help/assets/icons/Edit.svg) | **[!UICONTROL 重命名]** | 重命名项目。 打开&#x200B;**[!UICONTROL 重命名：*项目名称对话框&#x200B;*]**。 输入新名称并选择**[!UICONTROL 保存&#x200B;]**。 |
