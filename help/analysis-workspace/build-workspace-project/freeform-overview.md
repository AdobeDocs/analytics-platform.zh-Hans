...
| ![Delete](/help/assets/icons/Delete.svg) | **[!UICONTROL 删除]** | 删除一个或多个项目或文件夹。系统将提示您确认。<p>您删除的项目：</p><ul><li>无法恢复</li><li>已从项目列表中删除</li><li>无法再使用其URL进行访问</li><li>不再包含在计划投放中（如果之前已针对计划投放配置这些投放）<br/>有关计划投放的信息，请参阅[计划项目](/help/components/scheduled-projects-manager.md)。  </p> |
