...
*本文以&#x200B;**Customer Journey Analytics**记录自由格式表可视化图表。<br/>查看本文的&#x200B;**Adobe Analytics**版本的[自由格式表](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table)。*
