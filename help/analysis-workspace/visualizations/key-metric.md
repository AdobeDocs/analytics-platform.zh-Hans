...
*本文以&#x200B;**Customer Journey Analytics**记录关键指标摘要可视化。<br/>查看本文的&#x200B;**Adobe Analytics**版本的[关键量度摘要](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/key-metric)。*
