...
*本文以&#x200B;**Customer Journey Analytics**记录流失可视化图表。<br/>查看本文的&#x200B;**Adobe Analytics**版本的[流失](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow)。*
