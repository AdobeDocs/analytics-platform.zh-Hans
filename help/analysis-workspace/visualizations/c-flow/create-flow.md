...
| **[!UICONTROL 筛选列]** | 显示的过滤器选项与在自由格式表格中可用的选项相同。 有关可用选项的更多信息，请参阅[对表进行筛选和排序](/help/analysis-workspace/visualizations/freeform-table/filter-and-sort.md)中的“将简单或高级筛选器应用到表”一节。 |
