...
1. 选择&#x200B;[!UICONTROL **生成**]。
   ...
   如果您没有Journey Optimizer或未选择Journey Optimizer旅程，则会显示一个空白画布，您可以从此处开始将节点添加到旅程。
