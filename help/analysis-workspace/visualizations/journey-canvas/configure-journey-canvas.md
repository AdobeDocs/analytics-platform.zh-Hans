...
You can automatically show the top immediate nodes based on the nodes that are already on the canvas. 您可以将顶级节点添加到历程画布或在自由格式表中查看它们。
...
You can select a node and show the top dimension items that come immediately after it in the journey. 您可以将排名前3的维度项目作为单独的节点添加到历程画布中，也可以在自由格式表中查看所有排名最前的维度项目。
