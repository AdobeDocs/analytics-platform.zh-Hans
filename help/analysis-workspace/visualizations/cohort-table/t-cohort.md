...
1. 在[过滤器生成器](https://docs.adobe.com/content/help/zh-Hans/analytics/components/segmentation/segmentation-workflow/seg-build.html)中，进一步编辑区段，然后单击&#x200B;**[!UICONTROL 保存]**。
