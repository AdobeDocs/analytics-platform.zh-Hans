...
>title="将每个帐户中的购买团体活动可视化，以告知帐户和购买团体营销活动。"
>abstract="**这可以帮助您**&#x200B;直观地了解哪些购买群体，以及这些购买群体中的哪些人参与度最高，从而突出显示群体参与度方面的差距。<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如尝试与似乎不相关的购买团体中的人进行更多接触。"

可使用以下模板：

| 模板名称 | 为什么使用此模板<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **B2B帐户参与概述**] | 了解您的客户在活动、人员和机会中的活跃程度。<p>**这可以帮助您**&#x200B;更好地了解客户级别的参与度是呈上升还是下降趋势，比较不同客户之间的活动，以及决定将保留或客户获取工作集中在何处。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，将您的注意力重新集中到参与度较低但由于帐户的重要性而需要更多关注的帐户上。</p> |
| [!UICONTROL **B2B机会参与概述**] | 在机会级别跟踪参与情况，发现交易赢得或失去吸引力。<p>**这可以帮助您**&#x200B;更准确地预测交易进展，并将支持重点放在参与高峰或停滞的地方。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，对几乎已结束的交易进行额外的操作，并研究为什么其他交易会失去吸引力。</p> |
| [!UICONTROL **B2B购买团体活动**] | 将每个帐户中的购买团体活动可视化，以告知帐户和购买团体营销活动。<p>**这可以帮助您**&#x200B;直观地了解哪些购买群体，以及这些购买群体中的哪些人参与度最高，从而突出显示群体参与度方面的差距。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如尝试与似乎不相关的购买团体中的人进行更多接触。</p> |
