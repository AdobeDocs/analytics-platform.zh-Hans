...
| **产品使用情况概述** | 查看 Customer Journey Analytics 产品在贵组织内的使用情况。 <p>**这可以帮助您**&#x200B;更好地了解有多少人正在使用 Customer Journey Analytics、他们使用的频率以及随着时间推移的使用趋势。您还可以查看正在创建的项目数量和这些项目的详细信息（如最常用的组件、可视化和面板）以及许多其他使用统计数据。</p><p>**根据您所了解的情况，您可以**&#x200B;采取多种行动，例如删除未使用的项目或组件，或者为热门功能提供用户培训。</p> |
