...
>title="查看独特访客总数。 会显示某个时段的数据并与之前的时段的数据进行比较。 "
>abstract="**这可以帮助您**&#x200B;更好地了解您网站的访问范围和受众规模如何随时间增长或减少，或者与前期相比。<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，通过比较营销活动启动前后的独特访客，评估最近启动的营销活动是否成功吸引新访客访问网站。 或者，您也可以比较假日期间和去年同期访问网站的人员数量。<br/>此模板使用天维度和独特访客量度。 "
...
>title="查看访问站点的人员来自的国家/地区。"
>abstract="**这可以帮助您**&#x200B;更好地了解访问您网站的访客来自哪些最受欢迎的国家/地区。<br/>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用数据来专注于这些国家/地区的营销工作，或确保您的网站体验在具有不同主要语言的国家/地区达到最佳效果。<br/>此模板使用“国家/地区”维度。"
...
>title="查看访问站点的人员来自的州（美国）。 这与地域模板类似，只是该模板特定于美国。"
>abstract="**这可以帮助您**&#x200B;更好地了解访问您网站的美国最受欢迎访客来源。<br/>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用这些数据集中在这些状态下的营销工作。<br/>此模板使用美国州维度。"
...
>title="查看访问站点的人员来自的地理区域。 区域是小于国家/地区、大于城市的地理区域。 在某些国家，地区是一个州、省或专区。在其他地区，它是一个组成国家、部门或都市地区。 "
>abstract="**这可以帮助您**&#x200B;更好地了解访问您网站的最受欢迎区域访客。<br/>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用数据来集中在这些地区的营销工作，或确保您的网站体验在具有不同主要语言的地区是最佳的。 <br/>此模板使用ID（变量/地理国家/地区）和“区域”维度。 "
...
>title="查看访问站点的人员来自的城市。"
>abstract="**这可以帮助您**&#x200B;更好地了解访客来自访问您网站的最受欢迎城市。<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，使用这些数据集中在这些城市的营销工作。 <br/>此模板使用城市维度"
...
>title="查看访问站点的用户来自的美国境内的指定营销区域(DMA)。"
>abstract="**这可以帮助您**&#x200B;更好地了解访问您网站的最受欢迎区域访客。<br/>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用数据专注于最成功地区的营销工作。 "
...
>title="查看访客喜欢在其中查看内容的最常用语言。"
>abstract="**这可以帮助您**&#x200B;更好地了解访客最常使用的语言。<br/>**根据您所学到的内容，您可以**&#x200B;执行任意数量的操作，例如针对最流行的语言进行集中本地化或营销工作。<br/>此模板使用语言维度。"
...
>title="查看用户用于访问网站的常用浏览器的名称和版本。"
>abstract="**这有助于您**&#x200B;更好地了解访客最常使用的浏览器。<br/>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如通过使用最热门的浏览器测试网站的新版本来提高网站质量。 这样做可以最大限度地加强质量控制工作。<br/>此模板使用浏览器维度。"
...
>title="查看组织名称，这些组织开发了人们用于访问网站的热门浏览器。 这与浏览器模板的不同之处在于，它不会将同一浏览器的不同版本列为单独的维度项目。"
>abstract="**这可以帮助您**&#x200B;更好地了解访客使用的最常见浏览器&#x200B;<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如通过使用最热门的浏览器测试您网站的新版本来提高网站质量。 这样做可以最大限度地加强质量控制工作。 <br/>此模板使用浏览器类型维度。 "
...
| **地理国家/地区** | 查看访问站点的人员来自的国家/地区。<p>**这可以帮助您**&#x200B;更好地了解访问您网站的访客来自哪些最受欢迎的国家/地区。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用数据来专注于这些国家/地区的营销工作，或确保您的网站体验在具有不同主要语言的国家/地区达到最佳效果。</p><p>此模板使用国家/地区维度。 </p> |
| **美国地理州** | 查看访问站点的人员来自的州（美国）。 这与地域模板类似，只是该模板特定于美国。<p>**这可以帮助您**&#x200B;更好地了解访问您网站的美国最受欢迎访客来源。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用这些数据集中在这些状态下的营销工作。</p><p>此模板使用美国州维度。 </p> |
| **地理区域** | 查看访问站点的人员来自的地理区域。 区域是小于国家/地区、大于城市的地理区域。 在某些国家，地区是一个州、省或专区。在其他地区，它是一个组成国家、部门或都市地区。 <p>**这可以帮助您**&#x200B;更好地了解访问您网站的最受欢迎区域访客。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用数据来集中在这些地区的营销工作，或确保您的网站体验在具有不同主要语言的地区是最佳的。 </p><p>此模板使用ID（变量/地理国家/地区）和区域维度。 </p> |
| **地理城市** | 查看访问站点的人员来自的城市。 <p>**这可以帮助您**&#x200B;更好地了解访客来自访问您网站的最受欢迎城市。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，使用这些数据集中在这些城市的营销工作。 </p><p>此模板使用城市维度 </p> |
| **地域美国DMA** | 查看访问站点的用户来自的美国境内的指定营销区域(DMA)。<p>**这可以帮助您**&#x200B;更好地了解访问您网站的最受欢迎区域访客。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，使用数据专注于最成功地区的营销工作。 </p><p>此模板使用 </p> |
| **语言** | 查看访客喜欢在其中查看内容的最常用语言。 <p>**这可以帮助您**&#x200B;更好地了解访客最常使用的语言。</p><p>**根据您所学到的内容，您可以**&#x200B;执行任意数量的操作，例如针对最流行的语言进行集中本地化或营销工作。</p><p>此模板使用语言维度。</p> |
| **技术概述** | <p>**这有助于您更好地了解**</p><p>**根据您学到的内容，您可能**&#x200B;会执行任意数量的操作，例如 </p><p>此模板使用 </p> |
| **浏览器** | 查看用户用于访问网站的常用浏览器的名称和版本。<p>**这有助于您**&#x200B;更好地了解访客最常使用的浏览器。</p><p>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如通过使用最热门的浏览器测试网站的新版本来提高网站质量。 这样做可以最大限度地加强质量控制工作。</p><p>此模板使用浏览器维度。 </p> |
| **浏览器类型** | 查看组织名称，这些组织开发了人们用于访问网站的热门浏览器。 这与浏览器模板的不同之处在于，它不会将同一浏览器的不同版本列为单独的维度项目。<p>**这有助于您**&#x200B;更好地了解访客最常使用的浏览器</p><p>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如通过使用最热门的浏览器测试网站的新版本来提高网站质量。 这样做可以最大限度地加强质量控制工作。 </p><p>此模板使用浏览器类型维度。 </p> |
...
>title="使用自定义归因时，此模板显示访客如何到达您的网站。"
>abstract="**这有助于您**&#x200B;更好地了解您的哪些营销渠道最有效。<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，在有效的营销渠道上投入更多资金，从效果较低的营销渠道中抽身。<br/>此模板使用ID（变量/marketingchannel）维度和收入量度。"
...
>abstract="**这有助于您**&#x200B;更好地了解哪些营销渠道为您的网站带来了初始流量。<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在最有效的领域集中营销工作。<br/>此模板使用“首次接触渠道”维度。"
...
>title="查看有关访客在该访客的参与期（默认为30天）内与之匹配的第一个营销渠道的详细信息。"
>abstract="**这有助于您**&#x200B;更好地了解促使点击与营销渠道匹配的因素。 例如，如果访客到达您的网站且与“付费搜索”营销渠道匹配，则您可以使用渠道详细信息来查看使用了哪个搜索引擎或搜索了哪个关键词。<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在最有效的领域集中营销工作。<br/>此模板使用“首次联系渠道详细信息”维度。"
...
>title="查看有关营销活动表现的详细信息。"
>abstract="**这有助于您**&#x200B;更好地了解与促销活动关联的各种成功指标，如收入、产品查看次数、订单数等。<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，将营销工作重点放在带来最多收入的营销活动中。 <br/>此模板使用“收入”量度、“产品查看”量度、“购物车添加”量度、“订单”量度和单位量度。 它还使用跟踪代码维度和反向链接域维度。"
...
>title="查看网站获取访客的方式。"
>abstract="**这有助于您**&#x200B;更好地了解导致客户获取的各种因素，例如搜索关键字、反向链接域等。<br/>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，将营销工作集中在最有效的渠道中。<br/>此模板使用“跳出率”量度和“跳出次数”量度。 此外，它还使用搜索引擎维度、搜索关键词维度、登入页面维度、反向链接域维度、跟踪代码维度和反向链接维度。"
...
>title="查看访客用来访问您的网站的搜索关键词，无论是付费搜索还是免费搜索。"
>abstract="**这有助于您**&#x200B;更好地了解用户在导致网站流量的搜索中使用的关键词。 <br/>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如识别并填补正在使用的关键字与增加网站流量的关键字之间的SEO差距。<br/>此模板使用“搜索关键字”维度。"
...
>title="查看访客用来访问您的网站的搜索关键词，这些关键词与付费搜索检测相匹配。"
>abstract="**这有助于您**&#x200B;更好地了解用户在导致网站流量的搜索中使用的关键词。<br/>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如识别并填补正在使用的关键字与增加网站流量的关键字之间的SEO差距。 <br/>此模板使用搜索关键字 — 付费维度。 "
...
>title="查看访客用于访问网站的搜索关键词，这些关键词与付费搜索检测不匹配。"
>abstract="**这有助于您**&#x200B;更好地了解用户在导致网站流量的搜索中使用的关键词。<br/>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如识别并填补正在使用的关键字与增加网站流量的关键字之间的SEO差距。<br/>此模板使用“搜索关键字 — 免费”维度。 "
...
>title="查看访客用来访问您的网站的搜索引擎，无论是付费搜索引擎，还是免费搜索引擎。"
>abstract="**这有助于您**&#x200B;更好地了解用户使用搜索引擎产生网站流量。 <br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，将您的SEO工作重点放在为网站带来最多流量的搜索引擎上。<br/>此模板使用搜索引擎维度。 "
...
>title="查看访客用来访问您的网站的搜索引擎，这些搜索引擎与付费搜索检测相匹配。"
>abstract="**这有助于您**&#x200B;更好地了解用户使用搜索引擎产生网站流量。<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，将您的SEO工作重点放在为网站带来最多流量的搜索引擎上。 <br/>此模板使用搜索引擎 — 付费维度。"
...
>title="查看访客用于访问网站的搜索关键词，这些关键词与付费搜索检测不匹配。"
>abstract="**这有助于您**&#x200B;更好地了解用户使用搜索引擎产生网站流量。<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，将您的SEO工作重点放在为网站带来最多流量的搜索引擎上。<br/>此模板使用搜索引擎 — 免费维度。"
...
>title="查看用户通过点击哪些域来访问您的网站。"
>abstract="**这可以帮助您**&#x200B;更好地了解哪些第三方网站给您的网站带来了最多的流量。 （链接必须存在于外部网站上，且访客必须单击该链接才能显示维度项目。）<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如创建或调整内容，以更好地与来自顶级反向链接域的访客的兴趣保持一致。 <br/>此模板使用反向链接域维度。"
...
>title="查看用户为访问您的网站而点击的第一个反向链接域。 （设置后，它在该访客ID的整个生命周期内包含相同的值。）"
>abstract="**这可以帮助您**&#x200B;更好地了解哪些第三方网站最初为您的网站带来了流量。<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如创建或调整内容，以更好地与来自顶级原始反向链接域的访客的兴趣保持一致。 <br/>此模板使用原始反向链接域维度。"
...
>title="查看访客点击进入您的网站前所在的URL。 （链接必须存在于外部URL上，且访客必须单击该链接才能显示维度项目。）"
>abstract="**这有助于您**&#x200B;更好地了解哪些特定URL给您的网站带来了最多的流量。<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如创建或调整内容以更好地与来自顶级URL的访客的兴趣保持一致。 <br/>此模板使用反向链接域维度。</p>"
...
>title="查看访客点击了哪些通用渠道来访问您的网站。 Adobe维护每个渠道的规则。 可能的渠道包括搜索引擎、社交网络、其他网站、硬盘或电子邮件。"
>abstract="**这可以帮助您**&#x200B;更好地了解哪种类型的反向链接为您的网站带来最多流量。<br/>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如创建或调整内容以更好地与来自特定渠道的访客的兴趣保持一致。<br/>此模板使用反向链接类型维度。"
...
| 模板名称 | 为何使用此模板<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **营销渠道**] > [!UICONTROL **营销渠道概述报表**] | 使用自定义归因时，此模板显示访客如何到达您的网站。<p>**这有助于您**&#x200B;更好地了解您的哪些营销渠道最有效。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，在有效的营销渠道上投入更多资金，从效果较低的营销渠道中抽身。</p><p>此模板使用ID（变量/营销渠道）维度和收入量度。</p> |
| [!UICONTROL **营销渠道**] > [!UICONTROL **首次联系营销渠道**] | 查看访客在该访客的参与期（默认为30天）内与之匹配的第一个营销渠道。 <p>**这有助于您**&#x200B;更好地了解哪些营销渠道为您的网站带来了初始流量。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在最有效的领域集中营销工作。</p><p>此模板使用首次接触渠道维度。</p> |
| [!UICONTROL **营销渠道**] > [!UICONTROL **首次联系营销渠道详细信息**] | 查看有关访客在该访客的参与期（默认为30天）内与之匹配的第一个营销渠道的详细信息。<p>**这有助于您**&#x200B;更好地了解促使点击与营销渠道匹配的因素。 例如，如果访客到达您的网站且与“付费搜索”营销渠道匹配，则您可以使用渠道详细信息来查看使用了哪个搜索引擎或搜索了哪个关键词。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在最有效的领域集中营销工作。</p><p>此模板使用首次接触渠道详细信息维度。</p> |
| [!UICONTROL **营销渠道**] > [!UICONTROL **最近联系营销渠道**] | 查看访客在该访客的参与期（默认为30天）内与之匹配的最新营销渠道。<p>**这有助于您**&#x200B;更好地了解哪些营销渠道给您的网站带来了流量，从而导致转化。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在最有效的领域集中营销工作。</p><p>此模板使用“最近联系渠道”维度。  </p> |
| [!UICONTROL **营销渠道**] > [!UICONTROL **最近联系营销渠道详细信息**] | 查看有关访客在该访客的参与期（默认为30天）内与之匹配的最新营销渠道的详细信息<p>**这有助于您**&#x200B;更好地了解促使点击与营销渠道匹配的因素。 例如，如果访客到达您的网站且与“付费搜索”营销渠道匹配，则您可以使用渠道详细信息来查看使用了哪个搜索引擎或搜索了哪个关键词。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在最有效的领域集中营销工作。 </p><p>此模板使用“最近联系渠道详细信息”维度。 </p> |
...
| [!UICONTROL **促销活动**] > [!UICONTROL **促销活动效果**] | 查看有关营销活动表现的详细信息。<p>**这有助于您**&#x200B;更好地了解与促销活动关联的各种成功指标，如收入、产品查看次数、订单数等。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，将营销工作重点放在带来最多收入的营销活动中。 </p><p>此模板使用收入量度、产品查看量度、购物车添加量度、订单量度和件数量度。 它还使用跟踪代码维度和反向链接域维度。 </p> |
| **Web客户获取** | 查看网站获取访客的方式。<p>**这有助于您**&#x200B;更好地了解导致客户获取的各种因素，例如搜索关键字、反向链接域等。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如，将营销工作集中在最有效的渠道中。</p><p>此模板使用“跳出率”量度和“跳出次数”量度。 此外，它还使用搜索引擎维度、搜索关键词维度、登入页面维度、反向链接域维度、跟踪代码维度和反向链接维度。  </p> |
| **搜索关键字 — 全部** | 查看访客用来访问您的网站的搜索关键词，无论是付费搜索还是免费搜索。 <p>**这有助于您**&#x200B;更好地了解用户在导致网站流量的搜索中使用的关键词。 </p><p>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如识别并填补正在使用的关键字与增加网站流量的关键字之间的SEO差距。</p><p>此模板使用“搜索关键字”维度。 </p> |
| **搜索付费关键字** | 查看访客用来访问您的网站的搜索关键词，这些关键词与付费搜索检测相匹配。<p>**这有助于您**&#x200B;更好地了解用户在导致网站流量的搜索中使用的关键词。</p><p>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如识别并填补正在使用的关键字与增加网站流量的关键字之间的SEO差距。 </p><p>此模板使用“搜索关键字 — 付费”维度。 </p> |
| **搜索关键字 — 免费** | 查看访客用于访问网站的搜索关键词，这些关键词与付费搜索检测不匹配。<p>**这有助于您**&#x200B;更好地了解用户在导致网站流量的搜索中使用的关键词。</p><p>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如识别并填补正在使用的关键字与增加网站流量的关键字之间的SEO差距。</p><p>此模板使用“搜索关键字 — 免费”维度。 </p> |
| **搜索引擎 — 全部** | 查看访客用来访问您的网站的搜索引擎，无论是付费搜索引擎，还是免费搜索引擎。 <p>**这有助于您**&#x200B;更好地了解用户使用搜索引擎产生网站流量。 </p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，将您的SEO工作重点放在为网站带来最多流量的搜索引擎上。</p><p>此模板使用搜索引擎维度。 </p> |
| **付费搜索引擎** | 查看访客用来访问您的网站的搜索引擎，这些搜索引擎与付费搜索检测相匹配。<p>**这有助于您**&#x200B;更好地了解用户使用搜索引擎产生网站流量。</p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，将您的SEO工作重点放在为网站带来最多流量的搜索引擎上。 </p><p>此模板使用搜索引擎 — 付费维度。 </p> |
| **搜索引擎 — 免费** | 查看访客用于访问网站的搜索关键词，这些关键词与付费搜索检测不匹配。<p>**这有助于您**&#x200B;更好地了解用户使用搜索引擎产生网站流量。</p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如，将您的SEO工作重点放在为网站带来最多流量的搜索引擎上。</p><p>此模板使用“搜索引擎 — 免费”维度。 </p> |
| **反向链接域名** | 查看用户通过点击哪些域来访问您的网站。<p>**这可以帮助您**&#x200B;更好地了解哪些第三方网站给您的网站带来了最多的流量。 （链接必须存在于外部网站上，且访客必须单击该链接才能显示维度项目。）</p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如创建或调整内容，以更好地与来自顶级反向链接域的访客的兴趣保持一致。 </p><p>此模板使用反向链接域维度。 </p> |
| **原始反向链接域名** | 查看用户为访问您的网站而点击的第一个反向链接域。 （设置后，它在该访客ID的整个生命周期内包含相同的值。）<p>**这可以帮助您**&#x200B;更好地了解哪些第三方网站最初为您的网站带来了流量。</p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如创建或调整内容，以更好地与来自顶级原始反向链接域的访客的兴趣保持一致。 </p><p>此模板使用原始反向链接域维度。 </p> |
| **反向链接** | 查看访客点击进入您的网站前所在的URL。 （链接必须存在于外部URL上，且访客必须单击该链接才能显示维度项目。）  <p>**这有助于您**&#x200B;更好地了解哪些特定URL给您的网站带来了最多的流量。</p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如创建或调整内容以更好地与来自顶级URL的访客的兴趣保持一致。 </p><p>此模板使用反向链接域维度 </p><p>此模板使用反向链接维度。 </p> |
| **反向链接类型** | 查看访客点击了哪些通用渠道来访问您的网站。 Adobe维护每个渠道的规则。 可能的渠道包括搜索引擎、社交网络、其他网站、硬盘或电子邮件。<p>**这可以帮助您**&#x200B;更好地了解哪种类型的反向链接为您的网站带来最多流量。</p><p>**根据您了解的情况，您可能**&#x200B;执行任意数量的操作，例如创建或调整内容以更好地与来自特定渠道的访客的兴趣保持一致。</p><p>此模板使用反向链接类型维度。</p> |
...
>title="查看为移动设备提供蜂窝网络连接的电信公司。用户使用该公司访问您的网站。"
>abstract="**这可以帮助您**&#x200B;更好地了解哪些移动运营商在您的用户群中最受欢迎。<br/>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如根据不同运营商的网络功能定制内容交付，以确保流畅的用户体验。<br/>此模板使用“移动设备运营商”维度。"
...
>title="查看用户用于访问网站的移动设备的制造商和型号。"
>abstract="**这可以帮助您**&#x200B;更好地了解哪些移动设备在你的用户群中最受欢迎。<br/>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如针对最常见的移动设备优化网站的呈现。<br/>此模板使用移动设备名称维度。"
...
>title="查看用户用于访问网站的移动设备类型，如手机和平板电脑。"
>abstract="**这可以帮助您**&#x200B;更好地了解用于访问您网站的各种移动设备。<br/>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如针对使用最多的移动设备类型优化您的网站。<br/>此模板使用“移动设备类型”维度。"
...
>title="查看哪些制造商生产人们用来访问网站的移动设备，如Apple和三星。"
>abstract="**这可以帮助您**&#x200B;更好地了解哪些制造商在您的用户群中最受欢迎。<br/>**根据您所学到的内容，您可以**&#x200B;执行任意数量的操作，例如根据不同制造商的能力定制内容交付，以确保流畅的用户体验。<br/>此模板使用“移动设备制造商”维度。"
...
| 模板名称 | 为何使用此模板<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **移动设备运营商**] | 查看为移动设备提供蜂窝网络连接的电信公司。用户使用该公司访问您的网站。<p>**这可以帮助您**&#x200B;更好地了解哪些移动运营商在您的用户群中最受欢迎。</p><p>**根据您了解的情况，您可以**&#x200B;执行任意数量的操作，例如根据不同运营商的网络功能定制内容交付，以确保流畅的用户体验。</p><p>此模板使用“移动设备运营商”维度。</p> |
| **移动设备** | 查看用户用于访问网站的移动设备的制造商和型号。<p>**这可以帮助您**&#x200B;更好地了解哪些移动设备在你的用户群中最受欢迎。</p><p>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如针对最常见的移动设备优化网站的呈现。</p><p>此模板使用移动设备名称维度。</p> |
| **移动设备类型** | 查看用户用于访问网站的移动设备类型，如手机和平板电脑。<p>**这可以帮助您**&#x200B;更好地了解用于访问您网站的各种移动设备。</p><p>**根据您所了解的情况，您可以**&#x200B;执行任意数量的操作，例如针对使用最多的移动设备类型优化您的网站。</p><p>此模板使用移动设备类型维度。</p> |
| **制造商** | 查看哪些制造商生产人们用来访问网站的移动设备，如Apple和三星。<p>**这可以帮助您**&#x200B;更好地了解哪些制造商在您的用户群中最受欢迎。</p><p>**根据您所学到的内容，您可以**&#x200B;执行任意数量的操作，例如根据不同制造商的能力定制内容交付，以确保流畅的用户体验。</p><p>此模板使用移动设备制造商维度。</p> |
