...
>abstract="**这可以帮助您**&#x200B;了解您的内容在粒度级别上的表现。 您可以查看单个资产或特定属性的表现。 Content Analytics 使用 AI 自动生成属性，并用它们标记您的内容。 [更多信息&#x200B;](/help/content-analytics/content-analytics.md)<br/>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如在您的主页上推广高性能资产，将特定区段的内容个性化以包含高性能属性，或者轮换已开始陈旧的内容。"
