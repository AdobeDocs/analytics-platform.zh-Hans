...
>abstract="**这可以帮助您**&#x200B;更好地了解有多少人正在使用 Customer Journey Analytics、他们使用的频率以及随着时间推移的使用趋势。您还可以查看正在创建的项目数量和这些项目的详细信息（如最常用的组件、可视化和面板）以及许多其他使用统计数据。<br/>**根据您所了解的情况，您可以**&#x200B;采取多种行动，例如删除未使用的项目或组件，或者为热门功能提供用户培训。"
...
| **页面摘要** | 查看您所有资产中任何页面的关键信息。显示页面浏览量、趋势线、流量可视化等。  <p>**这可以帮助您**&#x200B;更好地了解人们如何与给定页面进行交互。</p><p>**根据您所了解的情况，您可以**&#x200B;采取多种行动，比如分析页面在一段时间内的性能，或者更好地理解是什么推动了页面流量的增长。</p><p>此模板使用页面查看次数量度。 它还使用 Line 可视化和 Flow 可视化。</p> |
...
| **产品使用情况概述**（即将推出） | 查看 Customer Journey Analytics 产品在贵组织内的使用情况。 <p>**这可以帮助您**&#x200B;更好地了解有多少人正在使用 Customer Journey Analytics、他们使用的频率以及随着时间推移的使用趋势。您还可以查看正在创建的项目数量和这些项目的详细信息（如最常用的组件、可视化和面板）以及许多其他使用统计数据。</p><p>**根据您所了解的情况，您可以**&#x200B;采取多种行动，例如删除未使用的项目或组件，或者为热门功能提供用户培训。</p> |
