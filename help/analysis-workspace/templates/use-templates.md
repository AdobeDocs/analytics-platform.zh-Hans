...
| 模板名称 | 为何使用此模板<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **首次与重复用户**] | 查看首次访客与回访访客的比较。 <p>**这可以帮助您**&#x200B;更好地了解您的网站在保持客户忠诚度方面的效率或您获得新客户的比率。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如为首次访客购买产品提供激励，以吸引他们回访。</p><p>此模板使用 </p> |
| **人员Id/命名空间** | <p>**这有助于您更好地了解**</p><p>**根据您学到的内容，您可能**&#x200B;会执行任意数量的操作，例如 </p><p>此模板使用  </p> |
| **位置概述** | 在地图可视化图表中查看访客位置概述。<p>**这可以帮助您**&#x200B;更好地了解访问您网站的访客所在的位置。 </p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，将营销资源集中在您最感兴趣和最有机会的地方。</p><p>此模板使用  </p> |
...
| **地域美国DMA** | 查看访问该网站的用户来自美国的哪些指定营销区域 (DMA)。<p>**这可以帮助您**&#x200B;更好地了解访问您网站的用户主要来自哪些地区。</p><p>**根据您所了解的情况，您可以**&#x200B;采取多种行动，比如利用这些数据来聚焦最成功的区域的营销工作。 </p><p>此模板使用 </p> |
...
| 模板名称 | 为何使用此模板<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **分钟（小时）**] | 查看您网站上的事件、会话和人员数量（按分钟划分）。 例如，如果您的报表具有单日的报表时间范围，则每小时的第一分钟将分组到同一维度项目中。<p>**这有助于您**&#x200B;在更精细的粒度级别更好地了解趋势。</p><p>**根据您学到的内容，您可能**&#x200B;会执行任意数量的操作，例如 </p><p>此模板使用小时的分钟维度。 |
| **小时** | 查看您网站上的事件、会话和人员，按一天中的小时划分。 例如，如果某个报表的时间跨度为1月1日至1月7日，则每天的第一个小时会分组到同一个维度项目中。<p>**这可以帮助您**&#x200B;更好地了解一天中您的网站最频繁和最不常访问的时间。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，在高流量时段向您的网站分配更多计算资源。</p><p>此模板使用小时数维度。 |
| **上午/下午** | 查看您网站上的活动、会话和人员，按上午和下午划分。 例如，如果某个报表的时间跨度为1月1日至1月7日，则每天的上午小时数会分组到同一个维度项目中。<p>**这可以帮助您**&#x200B;更好地了解一天中您的网站最常访问和最不常访问的时间。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，在高流量时段向您的网站分配更多计算资源。</p><p>此模板使用AM/PM维度。 |
| **每周时间** | 查看您网站上的活动、会话和人员，按星期几划分。 例如，如果某个报表跨越了1月份，则一周中的每一天都将分组到同一个维度项目中。 <p>**这可以帮助您**&#x200B;更好地了解您的网站在一周中的哪几天最常访问且访问频率最低。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如在高流量日更适当地为呼叫中心配备人员。</p><p>此模板使用星期维度。 |
| **日期** | 查看您网站上的活动、会话和人员，按月中的日划分。 例如，如果某个报表跨越全年，则当月的每一天都将分组到同一维度项目中。 <p>**这可以帮助您**&#x200B;更好地了解您的网站每个月的哪几天最频繁访问且访问频率最低。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如在高流量日更适当地为呼叫中心配备人员。</p><p>此模板使用日期维度。 |
...
| **工作日/周末** | 查看您网站上的事件、会话和人员，按工作日和周末进行划分。 例如，如果您的报表跨越一月，则工作日和周末会分组到单独的维度项目中。 <p>**这可以帮助您**&#x200B;更好地了解工作日与周末网站流量的差异。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，例如，如果报告显示周末比工作日繁忙，则在周末您的呼叫中心会增加员工。</p><p>此模板使用工作日/周末维度。 |
| **年周** | 查看您网站上的活动、会话和人员，按周划分。 例如，如果某个报表跨越多年，则每周将分组到同一维度项目中。<p>**这可以帮助您**&#x200B;更好地了解您的网站在一年中的哪些周最频繁且访问频率最低。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如在高流量周（如节假日）为呼叫中心配备更合适的员工。</p><p>此模板使用周数维度。 |
| **月份** | 查看您网站上的活动、会话和人员，按月份划分。 例如，如果某个报表跨越多年，则每个月会分组到同一维度项目中。<p>**这可以帮助您**&#x200B;更好地了解您的网站最常访问和最不常访问的月份。</p><p>**根据您所学到的内容，您可能**&#x200B;会执行任意数量的操作，例如在假期等高流量月份为呼叫中心配备更合适的员工。</p><p>此模板使用月份维度。 |
| **季度** | 查看您网站上的事件、会话和人员，按季度划分。 例如，如果某个报表跨越多年，则每个季度会分组到同一维度项目中。<p>**这可以帮助您**&#x200B;更好地了解您的网站最常访问和最不常访问的季度。</p><p>**根据您了解的情况，您可能**&#x200B;会执行任意数量的操作，如产品发布时间，以提升历史上流量较低的季度。</p><p>此模板使用季度维度。 |
