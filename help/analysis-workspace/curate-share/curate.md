...
>[!NOTE]
> 产品轮廓是控制用户可以查看哪些组件的主要机制。 它们通过[CX Enterprise Admin Console](https://experienceleague.adobe.com/zh-hans/docs/core-services/interface/administration/admin-tool-experience-cloud)进行管理。 “策划”是一个辅助区段。
