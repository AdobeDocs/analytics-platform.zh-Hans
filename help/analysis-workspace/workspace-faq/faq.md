...
| **如何实施 Analysis Workspace？** | 不要求执行任何特殊的实施操作。 所有有权访问 Customer Journey Analytics 的公司都可以使用 Analysis Workspace。 但是，内容（如项目组件）的标准权限同样适用于整理和共享项目。 请参阅[管理和访问要求](/help/analysis-workspace/workspace-faq/frequently-asked-questions-analysis-workspace.md)。 |
