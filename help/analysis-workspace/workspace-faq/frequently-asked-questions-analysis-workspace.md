...
role: Admin
TQID: https://experienceleague.adobe.com/AoadQDjrexnT5ZfQRvTeOICHVFPM-ekTNUejVTiiLik
...
运行 Analysis Workspace 的要求如下：

| 要求 | 描述 |
|--- |--- |
| 产品 SKU | 您的组织必须与 Adobe 签订一份 Analytics for Select、Prime 或 Ultimate 的有效合同，其中包含 Customer Journey Analytics 附加组件。 如果您不确定您拥有哪种合同类型，或不确定您是否拥有 Customer Journey Analytics 附加产品，请联系您的 Adobe 帐户团队。 此外，必须为您的组织配置 Adobe Experience Platform。 |
